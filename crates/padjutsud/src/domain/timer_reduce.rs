        ...
        TimerEvent::Wake => {
            ...
            if let Some(due) = wake_state.next_tick_due {
                if now >= due {
                    ...
                    step.transition.effects.extend(padjutsu.on_tick_effects());
                    if padjutsu.wants_fast_tick() {
            ...
            step.transition
                .effects
                .extend(padjutsu.due_repeat_effects(now));
            print_debug!(
            ...
            step.transition
                .effects
                .extend(padjutsu.button_repeat_effects(now));
            print_debug!(
...
mod tests {
    ...
    fn wake_timer_reschedules_after_due_repeat_setup() {
        ...
        use padjutsu_workspace::{AppRules, ButtonAction, ButtonRule, Profile};
        use std::sync::Arc;
        ...
        let _ = padjutsu.on_button_effects(
            1,
            Button::A,
